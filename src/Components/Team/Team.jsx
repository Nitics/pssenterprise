  ...
  <div className="responsive-container-block inner-container">
    ...
    <div className="responsive-cell-block wk-desk-8 wk-ipadp-8 wk-tab-12 wk-mobile-12 team-members-container">
      <div className="responsive-cell-block wk-desk-6 wk-ipadp-6 wk-mobile-12 wk-tab-12 card-container">
        <div className="card">
          <img className="card-img" src="https://workik-widget-assets.s3.amazonaws.com/widget-assets/images/ft12.svg"/>
      ...
      <div className="responsive-cell-block wk-desk-6 wk-ipadp-6 wk-mobile-12 wk-tab-12 card-container">
        <div className="card">
          <img className="card-img" src="https://workik-widget-assets.s3.amazonaws.com/widget-assets/images/ft13.svg"/>
          <p className="text-blk name">
          Sena Zungu
          </p>
          <p className="text-blk position">
      ...
      <div className="responsive-cell-block wk-desk-6 wk-ipadp-6 wk-mobile-12 wk-tab-12 card-container">
        <div className="card">
          <img className="card-img" src="https://workik-widget-assets.s3.amazonaws.com/widget-assets/images/ft14.svg"/>
          <p className="text-blk name">
          Sena Zungu
          </p>
          <p className="text-blk position">
